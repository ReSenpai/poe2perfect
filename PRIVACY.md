...
- **Runs only on mobalytics.gg.** The extension's script runs on `mobalytics.gg` pages and nowhere else.
- **Reads build pages.** It reads the build guide shown on the page you open, and may request the same public build
...
- **Stores display preferences locally.** Whether the guide or the original page is shown, whether the header and the
  summary panel are collapsed, and, for the last 30 builds you opened, the tab and build variant you were reading
  (kept by the build's address). They stay in your browser's extension storage.
